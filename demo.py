...
import sentiment
text = utils.read_file_lines("sentiment.txt")
...
sents = utils.print_file_lines("sentiment.txt")
...
translate microsoft.txt which is present in the /.mluhub \
directory for reference. """
mlcat(title="Summarization pipeline showcase", text=introduction) # noqa : E501
mlask(begin="", end="\n",
      prompt="Press Enter to display the summary of microsoft.txt")
print("Analysing...")
mlcat(title="Summary of microsoft.txt", text="", end="")
os.system("python3 summarize.py microsoft.txt --min_len 50 --max_len 100 --demo True") # noqa : E501
